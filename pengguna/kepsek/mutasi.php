...
<body>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-warning btn-sm"
                                                                            onclick="openEditModal('<?php echo $row['id_mutasi']; ?>', '<?php echo $row['tanggal_mutasi']; ?>', '<?php echo $row['tempat_mutasi']; ?>', '<?php echo $row['sk_mutasi']; ?>', '<?php echo $row['id_pegawai']; ?>')">Edit</button>
                                                                        <button class="btn btn-danger btn-sm"
                                                                            onclick="hapus('<?php echo $row['id_mutasi']; ?>')">Hapus</button>
                                                                    </td>
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="tanggal_mutasi" name="tanggal_mutasi" class="form-control"
                                        required>
                                </div>

                                <div class="mb-3">
                                    <label for="tempat_mutasi" class="form-label">Tempat Mutasi</label>
                                    <input type="text" id="tempat_mutasi" name="tempat_mutasi" class="form-control"
                                        required>
                                </div>

                                <div class="mb-3">
                                    <label for="sk_mutasi" class="form-label">SK Mutasi</label>
                                    <input type="text" id="sk_mutasi" name="sk_mutasi" class="form-control" required>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <!-- mutasi Pokok -->
                                <div class="mb-3">
                                    <label for="edit_tanggal_mutasi" class="form-label">Tanggal Mutasi</label>
                                    <input type="date" id="edit_tanggal_mutasi" name="tanggal_mutasi"
                                        class="form-control" required>
                                </div>

                                <!-- Tunjangan -->
                                <div class="mb-3">
                                    <label for="edit_tempat_mutasi" class="form-label">Tempat Mutasi</label>
                                    <input type="number" id="edit_tempat_mutasi" name="tempat_mutasi"
                                        class="form-control" required>
                                </div>

                                <!-- Potongan -->
                                <div class="mb-3">
                                    <label for="edit_sk_mutasi" class="form-label">SK Mutasi</label>
                                    <input type="number" id="edit_sk_mutasi" name="sk_mutasi" class="form-control"
                                        required>
                                </div>
    ...
    <script>
        ...
        function openEditModal(id_mutasi, tanggal_mutasi, tempat_mutasi, sk_mutasi, id_pegawai) {
            // Mengisi nilai input di modal edit
            document.getElementById('id_mutasi').value = id_mutasi;
            document.getElementById('edit_tanggal_mutasi').value = tanggal_mutasi;
            document.getElementById('edit_tempat_mutasi').value = tempat_mutasi;
            document.getElementById('edit_sk_mutasi').value = sk_mutasi;
