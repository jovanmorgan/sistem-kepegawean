                                                    ...
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <?php if (!empty($kepsek['fp'])): ?>
                                                                <img src="../../assets/img/fp_pengguna/kepsek/<?php echo $kepsek['fp']; ?>"
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $kepsek['nama_lengkap']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $kepsek['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_kepsek" id="id_kepsek"
                                                            value="<?php echo $kepsek['id_kepsek']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lengkap" type="text"
                                                                    ...
                                                                    value="<?php echo $kepsek['nama_lengkap']; ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="username" type="text" class="form-control"
                                                                    id="username"
                                                                    value="<?php echo $kepsek['username']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="password"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="password" type="text" class="form-control"
                                                                    id="password"
                                                                    value="<?php echo $kepsek['password']; ?>" />
                                                            </div>
                                                        </div>
