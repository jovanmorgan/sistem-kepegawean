...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['gambar_galeri']) && $_FILES['gambar_galeri']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['gambar_galeri']['tmp_name'], $target_file)) {
            ...
            $query = "UPDATE galeri SET nama='$nama', waktu='$waktu', deskripsi='$deskripsi', gambar_galeri='$gambar_galeri' WHERE id_galeri='$id_galeri'";
        } else {
            echo 'error';
            exit;
        }
        ...
        $query = "UPDATE galeri SET nama='$nama', waktu='$waktu', deskripsi='$deskripsi' WHERE id_galeri='$id_galeri'";
    }
