...
<body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <div class="mb-3">
                                    <label for="sk_pensiun" class="form-label">SK pensiun</label>
                                    <input type="text" id="sk_pensiun" name="sk_pensiun" class="form-control" required>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <!-- pensiun Pokok -->
                                <div class="mb-3">
                                    <label for="edit_tanggal_pensiun" class="form-label">Tanggal pensiun</label>
                                    <input type="date" id="edit_tanggal_pensiun" name="tanggal_pensiun"
                                        class="form-control" required>
                                </div>

                                <!-- Potongan -->
                                <div class="mb-3">
                                    <label for="edit_sk_pensiun" class="form-label">SK pensiun</label>
                                    <input type="text" id="edit_sk_pensiun" name="sk_pensiun" class="form-control"
                                        required>
                                </div>
    ...
    function openEditModal(id_pensiun, tanggal_pensiun, sk_pensiun, id_pegawai) {
        // Mengisi nilai input di modal edit
        document.getElementById('id_pensiun').value = id_pensiun;
        document.getElementById('edit_tanggal_pensiun').value = tanggal_pensiun;
        document.getElementById('edit_sk_pensiun').value = sk_pensiun;
