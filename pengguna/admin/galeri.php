...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between mt-3">
                                                ...
                                                <button
                                                    onclick="openEditModal('<?php echo $id_galeri; ?>', '<?php echo addslashes($nama); ?>', '<?php echo $waktu; ?>', '<?php echo addslashes($deskripsi); ?>', '<?php echo addslashes($gambar_galeri); ?>');"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="tambahForm" method="POST" action="proses/galeri/tambah.php"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file d-none" id="kover"
                                                name="gambar_galeri" onchange="previewImage(this, 'koverPreview')"
                                                accept="image/*">
            ...
            function openEditModal(id_galeri, nama, waktu, deskripsi, gambar_galeri) {
                // Set data to modal inputs
                document.getElementById('id_galeri').value = id_galeri;
                document.getElementById('edit-nama').value = nama;
                document.getElementById('edit-waktu').value = waktu;
                document.getElementById('edit-deskripsi').value = deskripsi;

                let gambar = "../../assets/img/galeri/" + gambar_galeri; // Perbaiki path jika perlu
                let editModal = new bootstrap.Modal(document.getElementById('editModal'));

                // Show preview of the existing image if available
                if (gambar_galeri !== '') { // Pastikan gambar ada sebelum menampilkan
