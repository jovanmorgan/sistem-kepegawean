                                    ...
                                    <div class="card">
                                        ...
                                        ?>
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $pegawai['nama_pegawai']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $pegawai['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_pegawai" id="id_pegawai"
                                                            value="<?php echo $pegawai['id_pegawai']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                                class="col-md-4 col-lg-3 col-form-label">Nama
                                                                Lengkap</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_pegawai" type="text"
