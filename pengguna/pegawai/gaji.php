...
<body>
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="edit_gaji_pokok" name="gaji_pokok" class="form-control"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="edit_tunjangan" name="tunjangan" class="form-control"
                                        required>
                                </div>
    ...
    function openEditModal(id_gaji, gaji_pokok, tunjangan, potongan, id_pegawai) {
